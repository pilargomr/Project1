...
public class TC002_Admin_SearchEmployee_NotExist {
  ...
  public void TC002_Admin_SearchEmployee_NotExist_Script() {
	  ...
	  driver.findElement(By.xpath("//*[@id=\"app\"]/div[1]/div[2]/div[2]/div/div[1]/div[2]/form/div[1]/div/div[1]/div/div[2]/input")).sendKeys("XYZ");
	  //xpath utilizado en el curso
	  ...
	  String actualValueMsg = driver.findElement(By.xpath("//*[@id=\"app\"]/div[1]/div[2]/div[2]/div/div[2]/div[2]/div/span")).getText();
	  //Assert.assertEquals(actualValueMsg, "No Records Found"); //HardAssertion
	  
	 // String actualValueTable = driver.findElement(By.xpath("//*[@id=\"app\"]/div[1]/div[2]/div[2]/div/div[2]/div[3]/div/div[2]/div/div/div[2]/div")).getText();
	  //Assert.assertEquals(actualValueTable, null); //HardAssertion
	    
	  	  
	  SoftAssert soft = new SoftAssert(); //SoftAssertion
	  soft.assertEquals(actualValueMsg, "No Records Found");
	  //soft.assertEquals(actualValueTable, null);
	  
	  //xpath copiado de la pag web:
	  //*[@id="app"]/div[1]/div[2]/div[2]/div/div[2]/div[2]/div/span
	  //*[@id="app"]/div[1]/div[2]/div[2]/div/div[2]/div[4]
	  //Step 8
